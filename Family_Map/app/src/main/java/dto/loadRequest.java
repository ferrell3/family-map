...
public class loadRequest {
     ...
     */
    private user[] users;       //registerRequest[] users; // These could be package local...

    /**
     * Array of person objects to be added to the database
     */
    private person[] persons;   //personResponse[] persons;

    /**
     * Array of event objects to be added to the database
     */
    private event[] events;     //eventResponse[] events;
